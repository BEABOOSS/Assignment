...
public class UserController {
     ...
     */
    public void createUser(String name, String email, String password, String gender, String address, String state, String country, String phoneNumber){
        User user = new User(name, email, password, gender, address, state, country, phoneNumber);
